...
class TextNormalizer():
    ...
    def _post_replace(self, sentence: str) -> str:
        ...
        # 四A更换
        sentence = sentence.replace('AAAAA级', '五诶级')
        sentence = sentence.replace('AAAA级', '四诶级')
        sentence = sentence.replace('AAA级', '三诶级')
        sentence = sentence.replace('AA级', '二诶级')
        sentence = sentence.replace('°', '度')
        sentence = sentence.replace('—', '至')
