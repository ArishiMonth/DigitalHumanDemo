...
class TTS:
    ...
    def set_prompt_text(self, prompt_text: str,prompt_lang: str):
        self._set_prompt_text(prompt_text,prompt_lang)

    def _set_prompt_text(self, prompt_text, prompt_lang):
