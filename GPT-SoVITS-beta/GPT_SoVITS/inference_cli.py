...
def main():
    ...
    parser.add_argument('--ref_text', required=False, help="Path to the reference text file")
    parser.add_argument('--ref_language', required=False, default='中文', choices=["中文", "英文", "日文"], help="Language of the reference audio")
    parser.add_argument('--target_text', required=True, help="Path to the target text file")
    parser.add_argument('--target_language', required=False, default='中英混合', choices=["中文", "英文", "日文", "中英混合", "日英混合", "多语种混合"], help="Language of the target text")
